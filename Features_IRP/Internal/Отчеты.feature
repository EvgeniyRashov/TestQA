...
Как Тестеровщик хочу
протестить отчеты
чтобы првоерить что у пользователя не возникает проблем   
...
Сценарий: _0902 проверка отчета Информация по номеклатуре
	...
	И в табличном документе "Result" ячейка с адресом "R4C3" равна "67676787889899" по шаблону
